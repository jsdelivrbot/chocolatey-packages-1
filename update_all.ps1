...
$Options = [ordered]@{
  ...
  Report           = @{
    ...
    Params = @{                                          #Report parameters:
      ...
      UserMessage     = "[Ignored](#ignored) | [History](#update-history) | [Force Test](https://gist.github.com/$Env:gist_id_test) | [Releases](https://github.com/nicholas-cecere/chocolatey-packages/releases) | **TESTING AU STREAMS VERSION**"       #  Markdown, Text: Custom user message to show
  ...
  Mail             = if ($Env:mail_user) {
    @{
      ...
      UserMessage = "Update status: Update status: https://gist.github.com/nicholas-cecere/$Env:gist_id"
